...
class MonthViewPagerAdapter extends PagerAdapter {
    ...
    /**
     * Gets month of ment2link in given position
    ...
    /**
     * Rebinds month, events and selected day for ment2link at given position
     * @param position    adapter position
     */
    ...
    /**
     * Gets cursor for ment2link events at given position
     * @param position    adapter position
    ...
    /**
     * Swaps cursor for ment2link events for given month
