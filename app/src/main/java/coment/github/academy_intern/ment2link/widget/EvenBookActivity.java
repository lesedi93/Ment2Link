package coment.github.academy_intern.ment2link.widget;
...
import coment.github.academy_intern.ment2link.CalendarUtils;
import coment.github.academy_intern.ment2link.ViewUtils;
 ...
 */
public class EvenBookActivity extends RelativeLayout {
    ...
    private Event mEvent = EvenBookActivity.Event.createInstance();
    private CalendarCursor mCursor;


    public EvenBookActivity(Context context) {
        this(context, null);
    }

    public EvenBookActivity(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EvenBookActivity(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        inflate(context, R.layout.activity_even_book, this);
     ...
     */
    @NonNull
    public EvenBookActivity.Event getEvent() {
        return mEvent;
    }
    ...
    /**
     * Sets name of selected event ment2link
     *
     * @param calendarName selected ment2link name
     */
    ...
    private void setCalendarId(long calendarId) {
        ...
        if (calendarId == EvenBookActivity.Event.NO_ID) {
    ...
    /**
     * View model for {@link EvenBookActivity}.
     * Event represented by this class is assumed to be in system timezone.
     */
    public static class Event implements Parcelable {

        public static final Creator<EvenBookActivity.Event> CREATOR = new Creator<EvenBookActivity.Event>() {
            @Override
            public EvenBookActivity.Event createFromParcel(Parcel in) {
                return new EvenBookActivity.Event(in);
            }

            @Override
            public EvenBookActivity.Event[] newArray(int size) {
                return new EvenBookActivity.Event[size];
            }
        };

        /**
         * Creates an instance of {@link EvenBookActivity.Event} that starts at 'earliest' future time
         *
         * @return an {@link EvenBookActivity.Event} instance
         */
        public static EvenBookActivity.Event createInstance() {
            return new EvenBookActivity.Event();
        }

        /**
         * Builder utility to build an {@link EvenBookActivity.Event}
         */
        public static class Builder {
            private final EvenBookActivity.Event event = new EvenBookActivity.Event();
             ...
             */
            public EvenBookActivity.Event.Builder id(long id) {
                event.id = id;
                return this;
            }

            /**
             * Sets event ment2link ID
             *
             * @param calendarId event ment2link ID
             * @return this instance (fluent API)
             */
            public EvenBookActivity.Event.Builder calendarId(long calendarId) {
             ...
             * @return this instance (fluent API)
             */
            public EvenBookActivity.Event.Builder title(String title) {
                event.title = title;
                return this;
            }
             ...
             * @return this instance (fluent API)
             */
            public EvenBookActivity.Event.Builder start(long timeMillis) {
             ...
             * @return this instance (fluent API)
             */
            public EvenBookActivity.Event.Builder end(long timeMillis) {
             ...
             * @return this instance (fluent API)
             */
            public EvenBookActivity.Event.Builder allDay(boolean isAllDay) {
                event.isAllDay = isAllDay;
                return this;
            }

            /**
             * Creates the {@link EvenBookActivity.Event} that has been built by this builder
             *
             * @return an {@link EvenBookActivity.Event} instance
             */
            public EvenBookActivity.Event build() {
                return event;
            }
        }
        ...
        /**
         * Checks if this instance has ment2link ID
         *
         * @return true if have ment2link ID, false otherwise
         */
        ...
        /**
         * Gets event ment2link ID
         *
         * @return event ment2link ID
         */
