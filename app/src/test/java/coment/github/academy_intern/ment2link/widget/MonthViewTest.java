...
import coment.github.academy_intern.ment2link.test.TestEventCursor;
import coment.github.academy_intern.ment2link.test.shadows.ShadowViewHolder;
import coment.github.academy_intern.ment2link.text.style.CircleSpan;
import coment.github.academy_intern.ment2link.text.style.UnderDotSpan;

import coment.github.academy_intern.ment2link.test.assertions.SpannableStringAssert;
...
public class MonthViewTest {
    ...
    public void testBindSelectedDay() {
        ...
        SpannableStringAssert.assertThat((SpannableString) actual).doesNotHaveSpan(CircleSpan.class);
        ...
        assertThat(actual).isInstanceOf(SpannableString.class);
        SpannableStringAssert.assertThat((SpannableString) actual).hasSpan(CircleSpan.class);
    }
    ...
    public void testBindCursor() {
        ...
        CharSequence actual = ((TextView) createBindViewHolder(10).itemView)
                .getText(); // 02-March-2016
        assertThat(actual).isInstanceOf(SpannableString.class);
        SpannableStringAssert.assertThat((SpannableString) actual).doesNotHaveSpan(UnderDotSpan.class);
        ...
        actual = ((TextView) createBindViewHolder(10).itemView).getText(); // 02-March-2016
        assertThat(actual).isInstanceOf(SpannableString.class);
        SpannableStringAssert.assertThat((SpannableString) actual).hasSpan(UnderDotSpan.class);
    }
