...
import coment.github.academy_intern.ment2link.test.shadows.ShadowLinearLayoutManager;
import coment.github.academy_intern.ment2link.test.shadows.ShadowRecyclerView;
...
public class MainActivityTest {
    ...
    public void testCalendarViewDayChange() {
        ...
        // swipe ment2link view left, should update title and scroll agenda view
    ...
    public void testAgendaViewDayChange() {
        ...
        // scroll agenda view to top, should update title and swipe ment2link view right
    ...
    public void testOptionsItemToday() {
        ...
        // swipe ment2link view left, should update title
        ((ShadowViewPager) ShadowExtractor.extract(calendarView)).swipeLeft();
