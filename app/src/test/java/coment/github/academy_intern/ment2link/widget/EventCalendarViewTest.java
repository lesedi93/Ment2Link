...
import coment.github.academy_intern.ment2link.test.shadows.ShadowViewPager;

import coment.github.academy_intern.ment2link.test.assertions.DayTimeAssert;
...
public class EventCalendarViewTest {
    ...
    public void testMonthData() {
        ...
        DayTimeAssert.assertThat(getMonthAt(2))
    ...
    public void testSwipeLeftChangeMonth() {
        ...
        DayTimeAssert.assertThat(actual).isEqualTo(2);
        DayTimeAssert.assertThat(getMonthAt(actual))
        ...
        DayTimeAssert.assertThat(actual).isEqualTo(3);
        DayTimeAssert.assertThat(getMonthAt(actual))
                .isInSameMonthAs(expected)
        ...
        shadowCalendarView.swipeLeft();
        actual = calendarView.getCurrentItem();
        DayTimeAssert.assertThat(actual).isEqualTo(1);
        DayTimeAssert.assertThat(getMonthAt(actual))
                .isInSameMonthAs(expected)
                .isMonthsBefore(getMonthAt(actual + 1), 1)
                .isMonthsAfter(getMonthAt(actual - 1), 1);
    ...
    public void testChangeActiveMonthSelectedDay() {
        ...
        DayTimeAssert.assertThat(getMonthAt(calendarView.getCurrentItem()))
                .isInSameMonthAs(todayMillis);
    ...
    public void testChangeSelectedDayToPreviousMonth() {
        ...
        DayTimeAssert.assertThat(getSelectedDay())
    ...
    public void testBindCursor() {
        // setting ment2link adapter should load and bind cursor
